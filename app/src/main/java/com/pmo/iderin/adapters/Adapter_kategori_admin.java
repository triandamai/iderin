...
public class Adapter_kategori_admin extends RecyclerView.Adapter<Adapter_kategori_admin.MyViewHolder> {
    ...
    @NonNull
    @Override
    public Adapter_kategori_admin.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return null;
    }

    @Override
    public void onBindViewHolder(@NonNull Adapter_kategori_admin.MyViewHolder holder, int position) {
